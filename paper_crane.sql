...
COPY public.client (user_id, client_name, website) FROM stdin;
\.
...
COPY public.employee (user_id, employee_name, employee_role) FROM stdin;
\.


--
-- Data for Name: employee_project_bridge; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.employee_project_bridge (user_id, project_lead_id, project_id) FROM stdin;
\.
...
COPY public.project (project_id, client_id, project_lead_id) FROM stdin;
\.
...
COPY public.task (project_id, task_id, description, deadline, start_date, expected_work_hours, progress_in_work_hours) FROM stdin;
\.
...
COPY public.time_off (time_off_id, employee_id, start_date, end_date, status, reason) FROM stdin;
\.
...
COPY public."user" (user_id, type, email, password) FROM stdin;
\.


--
-- Data for Name: video_training; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.video_training (video_id, video_link) FROM stdin;
\.
...
ALTER TABLE ONLY public.task
    ADD CONSTRAINT task_pkey PRIMARY KEY (project_id, task_id);
